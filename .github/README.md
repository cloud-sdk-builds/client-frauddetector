...
[`@aws-sdk/client-frauddetector`](https://www.npmjs.com/package/@aws-sdk/client-frauddetector/v/3.252.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-frauddetector@3.252.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-R4cyB+XziljslyLE9AvNWFlRj1bo5UK97dO1kYT1Bs//GPmKM2stqPDEK5KgQ+JO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-frauddetector": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-frauddetector@3.252.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-frauddetector@3.252.0/index.min.mjs": "sha384-R4cyB+XziljslyLE9AvNWFlRj1bo5UK97dO1kYT1Bs//GPmKM2stqPDEK5KgQ+JO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-frauddetector/blob/refs/tags/3.252.0/LICENSE
```
