...
[`@aws-sdk/client-frauddetector`](https://www.npmjs.com/package/@aws-sdk/client-frauddetector/v/3.687.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-frauddetector@3.687.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QKy4M3gl8cnSwtueAsvYzTb4rSKPegRjSoFIOkKLLJmLpdfZI2qsVBpcp11FICrK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-frauddetector": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-frauddetector@3.687.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-frauddetector@3.687.0/index.min.mjs": "sha384-QKy4M3gl8cnSwtueAsvYzTb4rSKPegRjSoFIOkKLLJmLpdfZI2qsVBpcp11FICrK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-frauddetector/blob/refs/tags/3.687.0/LICENSE
```
